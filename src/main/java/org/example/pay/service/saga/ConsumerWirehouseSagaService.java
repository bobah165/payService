package org.example.pay.service.saga;
...
public class ConsumerWirehouseSagaService {

  private static final String topicCreateOrder = "${topic.saga.warehouse}";
  ...
  public Order createOrder(Order orderEvent) {
    ...
    personAccountService.recoverSum(orderEvent.getPrice());
    return orderEvent;
  }
}
